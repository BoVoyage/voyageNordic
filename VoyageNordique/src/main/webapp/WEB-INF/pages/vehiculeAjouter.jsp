...
<body>
	...
	<form:form cssClass="form-horizontal" method="POST"
		action="soumettreAjoutVehicule" modelAttribute="vehiculeAjout">
		...
		<button type="submit" class="btn btn-default">Ajouter ce
			véhicule</button>
	</form:form>


	<c:if test="${not empty error}">
		<h1 style="color: red; text-align: center">Une erreur est survenue lors de l'ajout du véhicule !</h1>
	</c:if>
