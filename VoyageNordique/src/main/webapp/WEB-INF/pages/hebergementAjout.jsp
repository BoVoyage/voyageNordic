...
<body>
	...
	<form:form cssClass="form-horizontal" method="POST"
		action="soumettreAjoutHebergement" modelAttribute="ajoutHeb"
		...
		<button type="submit" class="btn btn-default">Ajouter cet
			hébergement</button>
	</form:form>

	<c:if test="${not empty error}">
		<h1 style="color: red; text-align: center">Une erreur est survenue lors de l'ajout de l'hébergement !</h1>
	</c:if>
