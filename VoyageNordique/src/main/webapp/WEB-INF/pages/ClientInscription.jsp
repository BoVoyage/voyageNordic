...
<title>Ma page Inscription Client</title>
	...
	<form:label cssClass="col-xs-2 control-label" path="noClient">Numero référence du Client</form:label>
		...
		<div class="form-group">
			<div class="col-xs-offset-2 col-xs-10">
				<button type="submit" class="btn btn-default">Inscription Client</button>
			</div>
		</div>
	</form:form>
		...
		<h1 style="color: red; text-align: center">Une erreur est survenue lors de l'inscription du client !</h1>
	</c:if>
