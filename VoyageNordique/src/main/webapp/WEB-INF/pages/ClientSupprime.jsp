...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form:form cssClass="form-horizontal" method="POST"
						action="soumettreSupprimeClient" modelAttribute="clientSupprime"
						enctype="multipart/form-data">

						<div class="form-group">
							<form:label cssClass="col-xs-3 control-label" path="noClient"
								cssStyle="color: blue">Numero référence du Client</form:label>
							<div class="col-xs-8">
								<form:input cssClass="form-control" placeholder="numero Client"
									path="noClient" />
							</div>
						</div>
	...
	<c:if test="${not empty error}">
		<h1 style="color: red; text-align: center">Une erreur est
			survenue lors de la suppression du client !</h1>
	</c:if>
